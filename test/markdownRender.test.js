...
const test_title = '[utils.js/makedownRender] ';
...
test(
  ...
  function (t) {
    ...
    t.equal(optionObj.content, '<h1 id="my-title"><a class="markdownIt-Anchor" href="#my-title">#</a> My Title</h1>\n<p>This is an example.</p>\n');
    t.end();
  }
);
...
test(
  ...
  function (t) {
    ...
    t.equal(optionObj.content, '<h2 id="html-文档的标题"><a class="markdownIt-Anchor" href="#html-文档的标题">#</a> HTML 文档的”标题“</h2>\n');
    t.end();
  }
);
...
test(
  ...
  function (t) {
    ...
    t.equal(optionObj.content, '<h1 id="my-title"><a class="markdownIt-Anchor" href="#my-title">#</a> My Title</h1>\n<h2 id="title-1"><a class="markdownIt-Anchor" href="#title-1">#</a> Title 1</h2>\n<h2 id="title-2"><a class="markdownIt-Anchor" href="#title-2">#</a> Title 2</h2>\n<h3 id="title-3"><a class="markdownIt-Anchor" href="#title-3">#</a> Title 3</h3>\n<h3 id="title-4"><a class="markdownIt-Anchor" href="#title-4">#</a> Title 4</h3>\n');
    t.end();
  }
);
...
test(
  ...
  function (t) {
    ...
    t.equal(optionObj.content, '<h2 id="你好"><a class="markdownIt-Anchor" href="#你好">#</a> 你好</h2>\n<h3 id="世界"><a class="markdownIt-Anchor" href="#世界">#</a> 世界</h3>\n');
    t.end();
  }
);
