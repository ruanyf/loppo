...
function makePreviousPage(root, optionObj) {
  ...
  if (pp === null) {
    ...
    optionObj.previous_page = '<a class="previouse-article-link" href="'
      ...
      + (Object.keys(pp)[0].substr(-3) === '.md'
        ? Object.keys(pp)[0].substr(0, Object.keys(pp)[0].length - 3) + '.html'
        : Object.keys(pp)[0])
      + '">&laquo; Previous</a>';
  }
  return optionObj;
...
function makeNextPage(root, optionObj) {
  ...
  if (np === null) {
    ...
    optionObj.next_page = '<a class="next-article-link" href="'
      + optionObj.relative_root_path
      + (Object.keys(np)[0].substr(-3) === '.md'
        ? Object.keys(np)[0].substr(0, Object.keys(np)[0].length - 3) + '.html'
        : Object.keys(np)[0])
      + '">Next &raquo;</a>';
  }
  return optionObj;
...
function makeBreadcrumb(root, optionObj) {
  ...
  optionObj.breadcrumbOrigin.forEach(function (c) {
    ...
    const str = '<a href="' + bcPath + '" class="breadcrumb-item" target="_blank">'
      + c[Object.keys(c)[0]]
      + '</a>';
    bcHTMLArr.push(str);
  });
